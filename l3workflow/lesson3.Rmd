...
## RStudio的界面{#myImagePage80}
![](pic/Rstudio1.png)


## RStudio的界面介绍{#myImagePage80}
![](pic/Rstudio2.png)


## RStudio的界面设定{#myImagePage80}
![](pic/Rpane.png)
...
## 创建Rmd文件：设定输出文件格式 {#myImagePage95}
![](pic/rmdtype.png)
